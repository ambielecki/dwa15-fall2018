...
This semester, the version of PHP we're using with MAMP is **php7.2.7**.

Given this, we'll use the php7.2.7 executable that comes with MAMP and is located in the directory `/Applications/MAMP/bin/php/php7.2.7/bin`.
...
```xml
/Applications/MAMP/bin/php/php7.2.7/bin
```
...
```bash
$ php -v
PHP 7.2.7 (cli) (built: Jul  3 2017 15:25:20) ( NTS )
